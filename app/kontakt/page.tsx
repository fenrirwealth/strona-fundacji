...
export default function ContactPage() {
  return <>
    <Header variant="dark" />
    <main id="main" className="min-h-screen bg-[#050505] text-white flex flex-col lg:flex-row">
      <div className="lg:w-1/2"><ContactInfo /></div>
      <div className="lg:w-1/2"><InteractiveForm /></div>
    </main>
    <Footer variant="dark" />
  </>;
}
