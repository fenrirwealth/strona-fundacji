...
const newsItems: NewsItem[] = [
  ...
  {
    id: 'wielkanocny-zajaczek',
    title: 'Wielkanocny Zajączek dla dzieci z onkologii',
    category: 'Święta',
    filters: ['Święta'],
    date: 'Kwiecień 2026',
    excerpt: 'Wiosenna akcja zbudowana z uważności, bliskości i drobnych gestów, które wnoszą światło w trudny czas.',
    image: '/assets/aktualnosci/przekazanie-darow.webp',
    imageAlt: 'Dzieci i opiekunowie przy zgromadzonych darach',
    size: 'narrow',
  },
  {
    id: 'magiczne-swieta-czwarta-edycja',
    title: 'Magiczne Święta: 4. edycja kampanii',
    category: 'Święta',
    filters: ['Święta', 'Współprace'],
    date: 'Grudzień 2025',
    excerpt: 'Kolejna odsłona kampanii, w której konkretne dziecięce marzenia spotykają się z hojnością darczyńców i partnerów.',
    image: '/assets/generated/magiczne-swieta-v1.webp',
    imageAlt: 'Elegancko zapakowane świąteczne paczki przygotowane dla dzieci',
    size: 'full',
  },
];
