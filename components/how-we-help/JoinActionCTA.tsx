...
export function JoinActionCTA() {
  ...
  return <section className="relative overflow-hidden px-5 py-28 sm:px-10 lg:px-16 lg:py-40 xl:px-24" aria-labelledby="join-heading">
    ...
    <motion.div
      className="absolute -left-36 inset-y-0 my-auto h-[30rem] w-[30rem] rounded-full bg-gold/[.11] blur-[150px]"
      animate={reducedMotion ? undefined : { x: [0, 90, 0], scale: [1, 1.12, 1] }}
      transition={{ duration: 14, repeat: Infinity, ease: 'easeInOut' }}
      aria-hidden="true"
    />
    <motion.div
      className="absolute -right-32 top-8 h-[26rem] w-[26rem] rounded-full bg-forest/20 blur-[140px]"
      animate={reducedMotion ? undefined : { x: [0, -70, 0], scale: [1.08, 0.96, 1.08] }}
