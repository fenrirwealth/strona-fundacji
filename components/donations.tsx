...
export function Donations() {
  return <section id="wsparcie" className="donation-section"><div className="shell"><Reveal className="donation-panel">
    <div className="donation-copy"><p className="eyebrow">04 / Wsparcie materialne i finansowe</p><h2>Pomóż tak,<br /><em>jak możesz.</em></h2><p>Możesz przekazać potrzebne rzeczy albo wesprzeć działania Fundacji przelewem. W sprawie darów rzeczowych napisz do nas wcześniej — potwierdzimy, czego dzieci i rodziny potrzebują w danym momencie.</p><a className="text-link" href="/kontakt?temat=wsparcie-materialne#formularz">Zapytaj o aktualne potrzeby <span aria-hidden="true">↗</span></a></div>
