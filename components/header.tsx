...
export function Header() {
  ...
  return <header ref={header} className="site-header"><div className="shell flex items-center justify-between gap-6">
    <a className="brand flex items-center gap-3" href="/" aria-label="Fundacja Lepszy Dom Lepsze Jutro — strona główna"><img src="/assets/logo-fundacji-transparent.svg" width="46" height="46" alt="" /><span>LEPSZY DOM<span>LEPSZE JUTRO</span><small>F U N D A C J A</small></span></a>
