...
export function Hero() {
  ...
  return <section ref={ref} className="hero shell" aria-labelledby="hero-title">
    ...
    <div className="hero-grid">
      ...
      <motion.figure style={{ y: reduced ? 0 : y }} className="hero-visual"><div className="image-frame"><img src="/assets/generated/hero-wolontariusze-v1.webp" width="724" height="543" alt="Wolontariusze przygotowujący paczki z pomocą — zdjęcie ilustracyjne" fetchPriority="high" /><span className="image-index">01 / LUDZIE I DZIAŁANIE</span></div><figcaption><span>Za każdą pomocą stoją ludzie.</span><span>Zdjęcie ilustracyjne</span></figcaption><div className="photo-note"><span className="note-rule" /><p>Wspólne wartości.<br /><strong>Konkretny kierunek.</strong></p></div></motion.figure>
    </div>
