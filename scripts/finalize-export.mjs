...
for (const file of ['archiwum.html', 'listy-do-swietego-mikolaja.html', 'kontakt.html', 'przejrzystosc.html', 'polityka-prywatnosci.html', '404.html']) cpSync(file, `out/${file}`);
