...
for (const file of ['aktualnosci.html', 'archiwum.html', 'listy-do-swietego-mikolaja.html', 'jak-pomagamy.html', 'kontakt.html', 'przejrzystosc.html', 'polityka-prywatnosci.html', '404.html']) cpSync(file, `out/${file}`);
